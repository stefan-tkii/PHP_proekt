...
<body class="boddie">
    <div class="container">
        ...
        <?php endif ?>
            ...
            <input class="txttype" type="text" id="username" name="username" placeholder="Enter username">

            <label class="para">Password:</label>
            <input class="txttype" type="password" id="password" name="password" placeholder="Enter password">
